...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        // is formatted, a JSONException exce   ption object will be thrown.
        ...
        try {
            ...
            JSONArray jsonArrayFeatures=rootObject.optJSONArray("features");

                for (int i=0;i<jsonArrayFeatures.length();i++){
                    JSONObject featureObject=jsonArrayFeatures.getJSONObject(i);
                    ...
                    Log.e("Magni:",""+earthquakes.toString());
                }
